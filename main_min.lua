...
end end for n=0,8do for e=0,8do r[e+114][n+114]=l[1]𝘶-=.00002end end for n=24,s-1-24,48do for e=24,s-1-24,48do r[e][n]|=2304end end end function n𝘻(n)local e,o=n+1,peek(n)local l,f=peek(e+o),e+o+1local n,d=f+l,{}for f=0,o-3,3do add(d,{(peek(e+f)-peek(n))*peek(n+3),(peek(e+f+1)-peek(n+1))*peek(n+3),(peek(e+f+2)-peek(n+2))*peek(n+3)})end local e={}for n=0,l-4,4do add(e,{peek(f+n),peek(f+n+1),peek(f+n+2),peek(f+n+3)})end local n={peek(n),peek(n+1),peek(n+2),peek(n+3)}return{d,e,n}end nc,w,n,n𝘢=10,0,i function en()i=g(2,0,0,500,0,0,0)end function e0()i.l-=.02i.d+=.05if(i.o-nc>40)i.o-=nc
if(i.o>1000)ee()
if(btn(5))nc,n𝘢=-40,true
end function ef()rectfill(0,0,128,128,0)n_()ng()nu()rectfill(0,0,128,8,6)print("prion",12,2,8)print("marcospiv 2023",47,2,7)print("🅾️thrust",20,100,8)print("❎ cannon",56,97,8)print("❎+❎ missile",56,103,8)print("<press ❎ to continue>",20,110,7)if(n𝘢)rectfill(0,80,128,128,0)print("loading terrain...",30,110,7)
end n𝘧,s,u,r,f,nk,n𝘸,y,z,h=time(),241,0,{},-33,33,1000,0,12a,c=z+1,30p,m,n𝘣,n𝘦,ej,nr,na,𝘷,w,𝘹,eo,nw,nj,nq,n,𝘺,𝘻,n2,n4,𝘪,j,𝘤,n5,𝘫,el=128-ceil(c/8)*8,20,80,63,63,-3,-300,0,0,0,125,0,.5,0,nil,0,0,0,0,0,{},{},{},0,50𝘬,𝘭,𝘮,𝘯,𝘰,nn=sin(nw),sin(nj),sin(nq),cos(nw),cos(nj),cos(nq)ed,e1,et,ei,ec,eu,er,ea,e2,b=nn*𝘰,-𝘮,nn*𝘭,𝘯*𝘮*𝘰+𝘬*𝘭,𝘯*nn,𝘯*𝘮*𝘭-𝘬*𝘰,𝘬*𝘮*𝘰-𝘯*𝘭,𝘬*nn,𝘬*𝘮*𝘭+𝘯*𝘰,function()end function nu()for n=0,z-1do j[n]={}end end nu()function e4()n𝘺()local n=s-1u,h=s*m,n/c e5()end function e3(n)n.f%=u n.o%=u end function e(n)return n\m end function eq(e,f,n)return(1-n)*e+n*f end function ey(n,e)return n.f-e.f,n.e-e.e,n.o-e.o end function 𝘧(n,e)return r[n%u\m][e%u\m]&255.99999end function 𝘱(n,e)return(r[n][e]&16128)>>>8end function n0(n,e)return r[n][e]&255.99999end function n3(n,e,f)return n*ed+e*e1+f*et,n*ei+e*ec+f*eu,n*er+e*ea+f*e2 end function ny(d,o,l,n,e,f)local n,o,l=d,o*cos(n)+l*sin(n),o*-sin(n)+l*cos(n)n,o,l=n*cos(f)+o*sin(f),n*-sin(f)+o*cos(f),l return n*cos(e)+l*sin(e),o,n*-sin(e)+l*cos(e)end function nh(n)return n>f*m and n<nk*m end function n8(n)return n>y*m and n<n𝘸*m end function nz(n)return n>w-200and n<w+200end function n𝘤(n,e)local f=n if(nh(n-u))f=n-u
if(nh(n+u))f=n+u
local n=e if(n8(e-u))n=e-u
if(n8(e+u))n=e+u
return f,n end function ns(n,e,o,l,d,u,f)local c,f,t,n,e,i,o,l,d=f,band(n,-1),band(o,-1),band(e,-1),band(l,-1),band(d,-1),band(u,-1)if(n>e)n,e,f,t=e,n,t,f
...
f[n][e]=o sset(p+e,p+n,l)e+=1end e=0n+=1end for n=0,1do for e=0,1do sset(p+e+13,p+n+14,7)end end end function e8()sspr(p,p,c,c,0,0,c+1,c+1)pset(𝘺\h,c+-𝘻\h,7)for n=1,#d do local n=d[n]local e,f=e(n.f),e(n.o)pset(e\h,c+-f\h,n.𝘢())end for n=24,s-1-24,48do for e=24,s-1-24,48do if(𝘱(e,n)==11)rectfill((e-24)/48*6,abs((n-24)/48*6-c),(e-24)/48*6+5+1,abs((n-24)/48*6+5-c+1),0)
end end end function es()n_()ex()rectfill(0,0,128,128,0)if nz(r[1][1]&255.99999)then local e={}for n=a*a-1,0,-1do local o,l=(n%a+f)%s,(n\a+y)%s local c,u,i=n%a*m+f*m,n0(o,l),n\a*m+y*m local f,t,d=c-𝘷,u-w,i-𝘹 if n%a==0then f+=n2*m elseif n%a==z then f+=n2*m-m elseif n\a==0then d+=n4*m elseif n\a==z then d+=n4*m-m end f,t,d=n3(f,t,d)local d,r=𝘢(f,t,d)add(e,{f,t,i,d,r,o,l})if n%a~=0and n%a<a-1and n\a~=0then local n=𝘱(o,l)srand(o*l)if(n>0)g(𝘱(o,l),c,u,i,nil,nil,nil,nil,e7[n],nil,nil,nil,true,true)
end end for n=1,#e do if n%a~=0and n>a-1then local n,o,l,u=e[n+1],e[n-a+1],e[n],e[n-a]local e,f,d,t,i,c,o,l,n=n[4],n[5],o[4],o[5],l[4],l[5],u[4],u[5],e6(n[6],n[7],true)if((e-d)*(l-t)-(f-t)*(o-d)<0)ns(e,f,d,t,o,l,n)
if((o-i)*(f-c)-(l-c)*(e-i)<0)ns(o,l,i,c,e,f,n)
fillp()else if n%a==0then local n=abs((n-(z+1))\a-(z+1))if(n<z)for e=#j[n],1,-1do j[n][e]:𝘧()end
end end end else ng()end nu()end function ng()for n=#j,0,-1do for e=#j[n],1,-1do j[n][e]:𝘧()end end end function n_()for n=#𝘤,1,-1do local n=𝘤[n]n:𝘥()if(n8(n.s)and nh(n.v)and nz(n.e))n.𝘸=true add(j[abs(n.s-y*m)\m],n)else n.𝘸=false
end end function ex()𝘺,𝘻,n2,n4=e(n.f),e(n.o),n.f/m%1,n.o/m%1𝘪,f,nk,y,n𝘸=n0(𝘺,𝘻),𝘺-(a\2-1),a+f-1,𝘻-(a\2-1),a+y-1end function n𝘨(n)for e=1,#n.x do local n=n.x[e]n[4],n[5]=𝘢(n[1],n[2],n[3])end for e=1,#n.𝘣 do local e=n.𝘣[e]local d=e[4]if(d&240>0)fillp(42405)else fillp()
local f,o,l=n.x[e[1]],n.x[e[2]],n.x[e[3]]local n,e,t=f[3],o[3],l[3]if n>na or e>na or t>na then if n<nr and e<nr and t<nr then local e,t,n,o,f,l=f[4],f[5],o[4],o[5],l[4],l[5]if max(f,max(e,n))>0and min(f,min(e,n))<128then if((e-n)*(l-o)-(t-o)*(f-n)<0)ns(e,t,n,o,f,l,d)
end end end end fillp()end function e9(n)n.v,n.s=n𝘤(n.f,n.o)local e,f,o=n.v-𝘷,n.e-w,n.s-𝘹 n.u,n.r,n.a=n3(e,f,o)end function ep(e)e.v,e.s=n𝘤(e.f,e.o)for o=1,#e.𝘨 do local n,f=e.x[o],e.𝘨[o]if(ev(e.𝘭,o))n[1],n[2],n[3]=ny(f[1],f[2],f[3],0,0,0)else n[1],n[2],n[3]=ny(f[1],f[2],f[3],e.d,e.l,e.𝘩)
n[1]+=e.v-𝘷 n[2]+=e.e-w n[3]+=e.s-𝘹 n[1],n[2],n[3]=n3(n[1],n[2],n[3])end end function em()for f=#𝘤,1,-1do local n,e=𝘤[f],false if n.g~=nil then n.g-=time()-n𝘧 if(n.g<0)e=true
end if n.m~=nil then if(n.m)e=true
end if not e then n:𝘫()e3(n)else deli(𝘤,f)if(n.k~=nil)n.k.m=true
...
end return n end function k(n,e,f,o,l,d,t,i,c,u,r,a)return n𝘩(0,n,e,f,0,0,0,i,c,t,o,l,d,r,false,u,a)end function g(n,e,f,o,l,d,t,i,c,u,r,a,h,s)return n𝘩(n,e,f,o,l,d,t,i,c,b,u,r,a,h,s)end function n𝘩(e,n,d,t,i,c,u,r,a,h,s,x,p,v,f,o,l)local n={𝘯=e,f=n,e=d,o=t,d=c or 0,l=i or 0,𝘩=u or 0,𝘫=r or b,𝘮=a or b,t=x or 0,i=s or 0,c=p or 0,g=o,𝘰=l,𝘨=𝘲[e][1],𝘣=𝘲[e][2],u=0,r=0,a=0,v=0,s=0,x={},𝘧=h or n𝘨,𝘬=v}f=f if e==0then n.𝘥=e9 if l then if(n5[𝘫]~=nil)n5[𝘫].m=true
n5[𝘫],𝘫=n,(𝘫+1)%el end if not n.𝘬 then n.k=k(n.f,𝘧(n.f,n.o),n.o,0,0,0,function(n)local n,e=𝘢(n.u,n.r,n.a)circfill(n,e,0,0)end,function(e)e.f,e.o=n.f,n.o+.05e.e=𝘧(n.f,n.o)if(n.e<=e.e)e.m=true
...
end if(f)add(_,n)add(j[abs(n.o-y*m)\m],n)else add(𝘤,n)
for e=1,#n.𝘨 do n.x[e]={}for f=1,3do n.x[e][f]=0end end n:𝘮()n:𝘥()return n end e_,ez,e𝘤,i,d,_,𝘦,n𝘪,𝘳,nx,𝘨,e𝘥,ne,nf,n𝘫,n𝘬,no,e𝘨,n𝘭,n𝘮,n7,𝘶,nl,eg,e𝘧,n𝘯,q,e𝘩,𝘴,eb,e𝘢,n6,𝘩,ek,𝘲=peek(24388),0,0,{},{},{},1,1,0,0,100,0,3,3,time(),time(),false,false,0,0,false,0,0,split"11,4,15,10",split"6,7",split"2,4,10,3,5",{},{},{},split"1, 1.5, 2",1,0,1,split"40,200,200,200,200,200,200",{[0]={{{0,0,0}},{}}}for n=1742,1807,2do add(𝘲,n𝘻(%n))end e7={[8]=function(n)if(time()%3==0)k(n.f+rnd"10"-4,n.e+10+rnd"8",n.o+rnd"10"-4,0,0,0,function(n)local n,e=𝘢(n.u,n.r,n.a)circfill(n,e,0,5)end,function(n)n.e+=rnd"0.4"n.f+=rnd"0.4"-.2n.o+=rnd"0.4"-.2end,b,4,false,true)
end,[9]=function(n)n.𝘭,n.l=split"1,2,3,4",time()g(10,n.f,n.e,n.o,n.l,nil,nil,nil,nil,nil,nil,nil,true,true)end}pal(1,140,1)pal(13,134,1)pal(15,138,1)pal(2,131,1)function 𝘥()poke(24388,e_)end function 𝘸(n,e,d)local o,f,l=n.f-e.f,0,n.o-e.o if(d)f=n.e-e.e
local n=atan2(o,f)local n=o*cos(n)+f*sin(n)local e=atan2(n,l)return n*cos(e)+l*sin(e)end function n𝘰(e,f,o,n)local l=n and 32or 26local n=g(l,e,f,o,.25,0,0,function(n)v(n,false,0)𝘣(n,4,-1)n.l+=.03n.d+=.03n.i+=(i.f-n.f)/𝘸(i,n)*.06n.t+=(i.e-n.e)/𝘸(i,n)*.06n.c+=(i.o-n.o)/𝘸(i,n)*.06𝘵(n,4)n𝘱(n)end,function(e)e._,e.𝘢=function()return n and 150or 400end,function()return n and 8or 14end end)add(d,n)n.p=function()x(n,#d)end end function ee()add(q,function(n,e,f)local o={}for l=0,3do o[l]=k(n,e,f,0,0,0)end local n=g(4,n,e,f,0,0,0,function(n)local e=𝘧(n.f,n.o)n.l+=.01if n.𝘦 then if(n.e-1>e+20)n.e-=1
...
end end 𝘥()end,function(n)n.𝘢,n._,n.w=function()return 12end,function()for e=0,3do np(n.w[e])end if(n.𝘦)return 50
return 100end,o for e=0,3do n.w[e].𝘫=function(f)f.f,f.e,f.o=n.f+sgn(e-2)*10,n.e-8,n.o+(e%2-1)*10end end n.𝘦,n.𝘪,n.h=false,0,{rnd"2"-1,rnd"2"-1}end)add(d,n)end)add(q,function(n,e,f)local n=g(6,n,e,f,.25,0,0,function(n)srand(time())local e=𝘸(i,n)if e<600or n.j then 𝘣(n,4,-1)n𝘲(n,n.e-𝘧(n.f,n.o),e)else if time()-n.q>.7then local e,f=n.f%u,n.o%u local e=sget(p+e\(h*m),p+c-f\(h*m))if e==4then if(flr(rnd"10")==1)n.𝘣,n.y,n.j=𝘲[16][2],.14,true
end end n.l+=(n.h-n.l)*.02+rnd"0.01"-.02n.f-=sin(n.l)*3n.o-=cos(n.l)*3if(time()%10==0)n.h=rnd"1"
end 𝘥()𝘵(n,4)end,function(n)n.j,n.y=false,.7n._,n.𝘢,n.q,n.h=function()if(n.j)return 500else return 300end,function()if(n.j)if(time()%.5<.25)return 8else return 9else return 9end,time(),rnd"1"end)add(d,n)n.p=function()x(n,#d)end end)add(q,function(n,e,f)local n=g(19,n,e,f,.25,0,0,function(n)𝘣(n,4,-1)n.l+=(n.h-n.l)*.02n.e=𝘧(n.f,n.o)+100n.f-=sin(n.l)*3n.o-=cos(n.l)*3if(time()%1==0)local n=k(n.f,n.e,n.o,0,0,0,function(n)local n,e=𝘢(n.u,n.r,n.a)spr(67,n,e)end,function(n)v(n,true,.2)end)n.p=function(e)e.m=true for e=-3,3do for f=-3,3do local e,f=e*m,f*m n9(n.f+e,n.o+f)end end end
end,function(n)n._,n.𝘢,n.h=function()return 800end,function()if(time()%.5<.25)return 12else return 0end,rnd"1"end)add(d,n)n.p=function()x(n,#d)end end)add(q,function(n,e,f)local n=g(21,n,e,f,.25,0,0,function(n)𝘣(n,4,-1)n𝘲(n,n.e-𝘧(n.f,n.o))𝘵(n,4)end,function(n)n.y,n.b=.3,2n._,n.𝘢,n.q,n.h=function()if(n.b==0)return 700else n.𝘣,n.y=𝘲[23][2],.6return 200end,function()if(time()%.5<.25)return 10else return 0end,time(),rnd"1"end)add(d,n)n.p=function(n)x(n,#d)end end)add(q,function(n,e,f)n𝘰(n,e,f)end)add(q,function(n,e,f)local n=g(28,n,e,f,0,0,0,function(n)𝘣(n,4,-1)n.e=𝘧(n.f,n.o)+100n.l+=.01n.o+=n.h[1]n.f+=n.h[2]n.z.f,n.z.e,n.z.o=n.f,n.e,n.o end,function(n)n.𝘢,n.b=function()if(time()%.5<.25)return 8else return 0end,5n.z=k(0,0,0,0,0,0,function(n)local e=𝘸(n,i,true)if(e<100)local e,f=𝘢(n.u,n.r,n.a)local o,l=𝘢(i.x[1][1],i.x[1][2],i.x[1][3])srand(time()%2)local d,t=(e+o)/2+rnd(16)-8,(f+l)/2line(e,f,d,t,7)line(d,t,o,l)local n,e=n.f-i.f,n.e-i.e local f=sqrt(n*n+e*e)local f=1/f*.2i.i+=f*n i.t+=f*e
end)n._,n.h=function()if(n.b==0)n.z.m=true return 500else return 0end,{rnd"2"-1,rnd"2"-1}end)add(d,n)end)add(q,function(n,e,f)local n=g(30,n,e,f,.25,0,0,function(n)𝘣(n,4,-1)n.l+=(n.h-n.l)*.02n.e=𝘧(n.f,n.o)+300n.f-=sin(n.l)*3n.o-=cos(n.l)*3if time()%8==0then if(𝘸(n,i)<150)n𝘰(n.f,n.e,n.o,true)
end end,function(n)n._,n.𝘢,n.b,n.h=function()if(n.b==0)return 2000else return 0end,function()return 0end,25,rnd"1"end)add(d,n)n.p=function()x(n,#d)end end)local n=1for f=1808,1850,7do 𝘴[n]={}for e=0,6do for f=1,@(f+e)do add(𝘴[n],{ek[e+1],function()srand(𝘩+𝘦)q[e+1](flr(rnd(u)),100,flr(rnd(u)))end})end end n+=1end e4()nd,n1=n𝘳,n𝘴 nv()end function e6(e,f)local o,d=n0(e,f),n𝘵(e,f)srand(f*e)local t,n=(e%4+f%4+flr((rnd"6")))%4+1,1if(o>0)n=10
if(o>15)n=eg[t]
...
if(n==10)n=138
else fillp()end 𝘥()return n end function n𝘵(n,e)return(r[n][e]&49152)>>>14end function n9(n,e)local f,o=n%u,e%u local n,e,l=f\m,o\m,𝘧(f,o)local d=n𝘵(n,e)if d==0and l>0and l~=68then r[n][e]+=16384sset(p+f\(h*m),p+c-o\(h*m),4)local f=𝘱(n,e)if(f==1)r[n][e]=r[n][e]&~16128|3840
if(f==13)r[n][e]=r[n][e]&~16128|4608
nl+=.00002end end function nt()x(i)n7=true ne-=1if(ne<0)extcmd"reset"
n𝘮=time()end function np(n)n.m=true if(n.k~=nil)n.k.m=true
end function e𝘸()print("𝘢ttack 𝘸ave  "..𝘦.." completed",18,60,7)print("𝘢rea infected  . . .     "..tostr(nl,2),7,80,7)print("𝘢rea uninfected  . . .   "..tostr(𝘶,2),7,90,7)print("𝘣onus uninfected area .  "..tostr(nx,2),7,105,7)end function e𝘣()if time()-n𝘭>5then 𝘩=1𝘦+=1if(𝘦>7)extcmd"reset"
nd,n1,𝘤=n𝘳,n𝘴,{}np(i)nv()end end function e𝘦()if(#d==0)nx=max(0,(𝘶-nl-nl)/max(32/𝘦,4))𝘳+=nx dset(0,max(dget(0),𝘳))nd,n1,n𝘭=e𝘸,e𝘣,time()
...
k(n.f,n.e,n.o+5,rnd"2"-1,rnd"4"+2,rnd"2"-1,function(n)local n,f=𝘢(n.u,n.r,n.a)circfill(n,f,0,e)end,function(n)v(n,true,.2)end,b,10,false,true)end 𝘥()np(n)deli(d,e)e𝘦()end function 𝘣(n,e,f)if(n.𝘸)sfx(e,f)
...
end function nm(n,f,e)local e,f=e or false,f or.2if 𝘨>0and e or not e then if(𝘨>0and e)𝘨-=.05
...
k(n.f,n.e,n.o,rnd"2"-1,rnd"2",rnd"2"-1,function(n)local n,f=𝘢(n.u,n.r,n.a)circfill(n,f,0,e)end,function(n)v(n,true,.1)end,b,1,false,true)end 𝘥()end end function n𝘲(n,f,e)local o=e or 𝘸(i,n)v(n,false,.05)local l,e=-atan2(i.f-n.f,i.o-n.o),-atan2(o,i.e-n.e)if o>100then nm(n,.4)if(n.e-i.e<20or f<60)e=-.15else e=-.25
else if(n.e-i.e<3or f<60)nm(n,.2)e=0
...
local e=d[n]._()ni(e>>16)n𝘹(d[n],e)sfx(3,3)if(not d[n].b or d[n].b<=0)x(d[n],n)
else 𝘨-=20end return true end end end return false end function n𝘹(n,e)if(e~=0)k(n.f,n.e,n.o,0,0,0,function(n)local n,f=𝘢(n.u,n.r,n.a)print(e,n,f,7)end,function(n)n.e+=.1end,b,5,false,true)
end function n𝘷(o)for n=#_,1,-1do if sqrt(abs(o.v-_[n].v)+abs(o.e-_[n].e)+abs(o.s-_[n].s))<5then _[n].i=o.i _[n].c=o.c _[n].t=o.t local e,f=e(_[n].v%u),e(_[n].s%u)local l=𝘱(e,f)if l==1or l==15then x(_[n])r[e][f]=r[e][f]&~16128|2048if(l==15)ni(.00062)n𝘹(o,"40")
end if(l==6)ni(.00062)x(_[n])r[e][f]=r[e][f]&~16128|2048
if(l==9)x(_[n])r[e][f]=r[e][f]&~16128|2816
if(l==13)x(_[n])r[e][f]=r[e][f]&~16128|3584
return true end end return false end function ni(n)𝘳+=n if(𝘳>n𝘪*.0763)n𝘪+=1ne+=1nf+=1
end function nv()i=g(2,118*m,0,118.5*m,.25,0,0,function(n)v(n,false,.12)if(nb(n))nt()
if(n𝘷(n))nt()
...
end else if(𝘪==l[1])𝘨=100
end if n.e<1200then if(btn"4")nm(n,.5,true)
end 𝘵(n,8)poke(24413,5)if btn"5"then if(time()-n𝘫>.1)n𝘶(n)ni(~0)n𝘫=time()
if not no then if time()-n𝘬<.2then nf-=1if nf>=0then local n=g(24,n.f,n.e,n.o,n.l,n.d,0,function(e)v(e,false,0)local f,o=𝘸(e,e.𝘤),-atan2(e.v-e.𝘤.v,e.s-e.𝘤.s)e.l+=o-.25-e.l local f=atan2(f,e.e-e.𝘤.e)e.d+=f-e.d e.i-=sin(e.l)e.t-=sin(e.d)e.c-=cos(e.l)if(nb(e,n,2))x(e)
𝘵(e,10)n𝘱(e)end,function(n)n.g=10local e,f=0,32767for o=1,#d do local n=𝘸(n,d[o])if(n<f)e,f=o,n
end n.𝘤=d[e]end,n.i-sin(n.l)*15,n.t-sin(n.d)*15,n.c-cos(n.l)*15)n.p=function(n)x(n)end end end n𝘬,no=time(),true end else if(no)no=false
end 𝘥()end)i.p,n=function(n)if(sqrt(n.i^2+n.t^2+n.c^2)>3or abs(n.d)>.03)nt()
end,i end function 𝘵(n,e)local f=sqrt(n.i^2+n.t^2+n.c^2)local e=f>e and e/f or 1n.i,n.t,n.c=e*n.i,e*n.t,e*n.c end function e𝘪()x(i)nt()end function n𝘴()if(n7)if(time()-n𝘮>5)n7=false nv()
em()n𝘧,_,𝘷,𝘹=time(),{},n.f,n.o-eo if(n.e>𝘪+50)w=n.e-20else w=𝘪+30
n6+=1if 𝘩<#𝘴[𝘦]+1then if(n6>=𝘴[𝘦][𝘩][1])n6=0𝘴[𝘦][𝘩][2]()𝘩+=1
end end function ew()rectfill(c+1,0,128,12,6)print("score",c+1+1,1,7)print(tostr(𝘳,2),c+1+1,7,7)for n=1,nf do spr(65,58+n*5+3,5)end for n=1,ne do spr(64,58+n*5,0)end print("wave",c+1+58,1,7)print(𝘦,c+1+58,7,7)print("best",c+1+78,1,7)print(tostr(dget(0),2),c+1+78,7,7)rectfill(c,14,𝘨+c,14,10)rectfill(c,16,i.e/7+c,16,11)end function n𝘳()es()ew()e8()end n1,nd=e0,ef function _init()cartdata"marcospiv_prion_v1"en()end function _update()n1()end function _draw()nd()end
__gfx__
