...
return 100end,o for e=0,3do n.w[e].𝘫=function(f)f.f,f.e,f.o=n.f+sgn(e-2)*10,n.e-8,n.o+(e%2-1)*10end end n.𝘦,n.𝘪,n.h=false,0,{rnd"2"-1,rnd"2"-1}end)add(d,n)end)add(q,function(n,e,f)local n=g(6,n,e,f,.25,0,0,function(n)local f=𝘧(n.f%u,n.o%u)srand(time())local e=𝘸(i,n)if e<600or n.j then 𝘣(n,4,-1)n𝘲(n,f,e)else if time()-n.q>.7then local e,f=n.f%u,n.o%u local e=sget(p+e\(h*m),p+c-f\(h*m))if e==4then if(flr(rnd"10")==1)n.𝘣,n.y,n.j=𝘲[16][2],.14,true
end end n.l+=(n.h-n.l)*.02+rnd"0.01"-.02n.f-=sin(n.l)*3n.o-=cos(n.l)*3if(time()%10==0)n.h=rnd"1"
end 𝘥()𝘵(n,4)end,function(n)n.j,n.y=false,.7n._,n.𝘢,n.q,n.h=function()if(n.j)return 500else return 300end,function()if(n.j)if(time()%.5<.25)return 8else return 9else return 9end,time(),rnd"1"end)add(d,n)n.p=function()x(n,#d)end end)add(q,function(n,e,f)local n=g(19,n,e,f,.25,0,0,function(n)𝘣(n,4,-1)local e=𝘧(n.f,n.o)n.l+=(n.h-n.l)*.02n.e=e+100n.f-=sin(n.l)*3n.o-=cos(n.l)*3if(time()%1==0)local n=k(n.f,n.e,n.o,0,0,0,function(n)local n,e=𝘢(n.u,n.r,n.a)spr(67,n,e)end,function(n)v(n,true,.2)end)n.p=function(e)e.m=true for e=-3,3do for f=-3,3do local e,f=e*m,f*m n9(n.f+e,n.o+f)end end end
end,function(n)n._,n.𝘢,n.h=function()return 800end,function()if(time()%.5<.25)return 12else return 0end,rnd"1"end)add(d,n)n.p=function()x(n,#d)end end)add(q,function(n,e,f)local n=g(21,n,e,f,.25,0,0,function(n)𝘣(n,4,-1)local e=n.e-𝘧(n.f,n.o)n𝘲(n,e)𝘵(n,4)end,function(n)n.y,n.b=.3,2n._,n.𝘢,n.q,n.h=function()if(n.b==0)return 700else n.𝘣,n.y=𝘲[23][2],.6return 200end,function()if(time()%.5<.25)return 10else return 0end,time(),rnd"1"end)add(d,n)n.p=function(n)x(n,#d)end end)add(q,function(n,e,f)n𝘰(n,e,f)end)add(q,function(n,e,f)local n=g(28,n,e,f,0,0,0,function(n)𝘣(n,4,-1)local e=𝘧(n.f,n.o)n.e=e+100n.l+=.01n.o+=n.h[1]n.f+=n.h[2]n.z.f,n.z.e,n.z.o=n.f,n.e,n.o end,function(n)n.𝘢,n.b=function()if(time()%.5<.25)return 8else return 0end,5n.z=k(0,0,0,0,0,0,function(n)local e=𝘸(n,i,true)if(e<100)local e,f=𝘢(n.u,n.r,n.a)local o,l=𝘢(i.x[1][1],i.x[1][2],i.x[1][3])srand(time()%2)local d,t=(e+o)/2+rnd(16)-8,(f+l)/2line(e,f,d,t,7)line(d,t,o,l)local n,e=n.f-i.f,n.e-i.e local f=sqrt(n*n+e*e)local f=1/f*.2i.i+=f*n i.t+=f*e
end)n._,n.h=function()if(n.b==0)n.z.m=true return 500else return 0end,{rnd"2"-1,rnd"2"-1}end)add(d,n)end)add(q,function(n,e,f)local n=g(30,n,e,f,.25,0,0,function(n)𝘣(n,4,-1)local e=𝘧(n.f,n.o)n.l+=(n.h-n.l)*.02n.e=e+300n.f-=sin(n.l)*3n.o-=cos(n.l)*3if time()%8==0then if(𝘸(n,i)<150)n𝘰(n.f,n.e,n.o,true)
